...
class Actor(nn.Module):
	...
	def forward(self, state):
		...
		a = F.relu(self.l2(a))
		return torch.tensor([11, 72, 72, 10, 10, 10, 10, 10, 10, 10, 10], device="cuda") * torch.relu(self.l3(a))
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		# Q1 architecture
		self.l1 = nn.Linear(state_dim + action_dim, 8192)
		self.l2 = nn.Linear(8192, 8192)
		self.l3 = nn.Linear(8192, 1)

		# Q2 architecture
		self.l4 = nn.Linear(state_dim + action_dim, 8192)
		self.l5 = nn.Linear(8192, 8192)
		self.l6 = nn.Linear(8192, 1)
